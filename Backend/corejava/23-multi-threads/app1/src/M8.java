public class M8
{
	public static void main(String[] args)
	{
		...
		Thread t1 = Thread.currentThread();//reference
		//reading default properties of main thread
		System.out.println(t1.getName());
		System.out.println(t1.isDaemon());//the life of thread is dependt is parent thread.
		System.out.println(t1.getId());//long type it is random.
