...
class M7
{
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("----------");
		//database name
		System.out.println(rsmd.getColumnClassgName(1));
		System.out.println(rsmd.getColumnClassName(2));
		System.out.println("----------");
		//class name
		System.out.println(rsmd.getColumnLabelgName(1));
		System.out.println(rsmd.getColumnLabelName(2));
		System.out.println("----------");
		//allis name
		System.out.println(rsmd.getColumnTyoegName(1));
